...
{
 tprint_struct_begin();
 do { tprints_field_name("level"); tprintf_string("%lld", (sizeof((*p).level) == sizeof(char) ? (long long) (char) ((*p).level) : sizeof((*p).level) == sizeof(short) ? (long long) (short) ((*p).level) : sizeof((*p).level) == sizeof(int) ? (long long) (int) ((*p).level) : sizeof((*p).level) == sizeof(long) ? (long long) (long) ((*p).level) : (long long) ((*p).level))); } while (0);
 tprint_struct_next();
...
{
 tprint_struct_begin();
 do { tprints_field_name("start_level"); tprintf_string("%lld", (sizeof((*p).start_level) == sizeof(char) ? (long long) (char) ((*p).start_level) : sizeof((*p).start_level) == sizeof(short) ? (long long) (short) ((*p).start_level) : sizeof((*p).start_level) == sizeof(int) ? (long long) (int) ((*p).start_level) : sizeof((*p).start_level) == sizeof(long) ? (long long) (long) ((*p).start_level) : (long long) ((*p).start_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("end_level"); tprintf_string("%lld", (sizeof((*p).end_level) == sizeof(char) ? (long long) (char) ((*p).end_level) : sizeof((*p).end_level) == sizeof(short) ? (long long) (short) ((*p).end_level) : sizeof((*p).end_level) == sizeof(int) ? (long long) (int) ((*p).end_level) : sizeof((*p).end_level) == sizeof(long) ? (long long) (long) ((*p).end_level) : (long long) ((*p).end_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_end();
}
...
print_ff_periodic_effect(const typeof(((struct_ff_effect *)0)->u.periodic) *const p)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("magnitude"); tprintf_string("%lld", (sizeof((*p).magnitude) == sizeof(char) ? (long long) (char) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(short) ? (long long) (short) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(int) ? (long long) (int) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(long) ? (long long) (long) ((*p).magnitude) : (long long) ((*p).magnitude))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("offset"); tprintf_string("%lld", (sizeof((*p).offset) == sizeof(char) ? (long long) (char) ((*p).offset) : sizeof((*p).offset) == sizeof(short) ? (long long) (short) ((*p).offset) : sizeof((*p).offset) == sizeof(int) ? (long long) (int) ((*p).offset) : sizeof((*p).offset) == sizeof(long) ? (long long) (long) ((*p).offset) : (long long) ((*p).offset))); } while (0);
 tprint_struct_next();
...
ff_effect_ioctl(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("id"); tprintf_string("%lld", (sizeof((ffe).id) == sizeof(char) ? (long long) (char) ((ffe).id) : sizeof((ffe).id) == sizeof(short) ? (long long) (short) ((ffe).id) : sizeof((ffe).id) == sizeof(int) ? (long long) (int) ((ffe).id) : sizeof((ffe).id) == sizeof(long) ? (long long) (long) ((ffe).id) : (long long) ((ffe).id))); } while (0);
 tprint_struct_next();
