...
decode_response(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("resid"); tprintf_string("%lld", (sizeof((sg_io).resid) == sizeof(char) ? (long long) (char) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(short) ? (long long) (short) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(int) ? (long long) (int) ((sg_io).resid) : sizeof((sg_io).resid) == sizeof(long) ? (long long) (long) ((sg_io).resid) : (long long) ((sg_io).resid))); } while (0);
 tprint_struct_next();
