...
int sys_sysctl(struct tcb *tcp)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("nlen"); tprintf_string("%lld", (sizeof((info).nlen) == sizeof(char) ? (long long) (char) ((info).nlen) : sizeof((info).nlen) == sizeof(short) ? (long long) (short) ((info).nlen) : sizeof((info).nlen) == sizeof(int) ? (long long) (int) ((info).nlen) : sizeof((info).nlen) == sizeof(long) ? (long long) (long) ((info).nlen) : (long long) ((info).nlen))); } while (0);
 tprint_struct_next();
