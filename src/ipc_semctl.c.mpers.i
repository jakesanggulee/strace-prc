       ...
       const unsigned int cmd, const _Bool indirect_addr)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("semmap"); tprintf_string("%lld", (sizeof((info).semmap) == sizeof(char) ? (long long) (char) ((info).semmap) : sizeof((info).semmap) == sizeof(short) ? (long long) (short) ((info).semmap) : sizeof((info).semmap) == sizeof(int) ? (long long) (int) ((info).semmap) : sizeof((info).semmap) == sizeof(long) ? (long long) (long) ((info).semmap) : (long long) ((info).semmap))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmni"); tprintf_string("%lld", (sizeof((info).semmni) == sizeof(char) ? (long long) (char) ((info).semmni) : sizeof((info).semmni) == sizeof(short) ? (long long) (short) ((info).semmni) : sizeof((info).semmni) == sizeof(int) ? (long long) (int) ((info).semmni) : sizeof((info).semmni) == sizeof(long) ? (long long) (long) ((info).semmni) : (long long) ((info).semmni))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmns"); tprintf_string("%lld", (sizeof((info).semmns) == sizeof(char) ? (long long) (char) ((info).semmns) : sizeof((info).semmns) == sizeof(short) ? (long long) (short) ((info).semmns) : sizeof((info).semmns) == sizeof(int) ? (long long) (int) ((info).semmns) : sizeof((info).semmns) == sizeof(long) ? (long long) (long) ((info).semmns) : (long long) ((info).semmns))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmnu"); tprintf_string("%lld", (sizeof((info).semmnu) == sizeof(char) ? (long long) (char) ((info).semmnu) : sizeof((info).semmnu) == sizeof(short) ? (long long) (short) ((info).semmnu) : sizeof((info).semmnu) == sizeof(int) ? (long long) (int) ((info).semmnu) : sizeof((info).semmnu) == sizeof(long) ? (long long) (long) ((info).semmnu) : (long long) ((info).semmnu))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semmsl"); tprintf_string("%lld", (sizeof((info).semmsl) == sizeof(char) ? (long long) (char) ((info).semmsl) : sizeof((info).semmsl) == sizeof(short) ? (long long) (short) ((info).semmsl) : sizeof((info).semmsl) == sizeof(int) ? (long long) (int) ((info).semmsl) : sizeof((info).semmsl) == sizeof(long) ? (long long) (long) ((info).semmsl) : (long long) ((info).semmsl))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semopm"); tprintf_string("%lld", (sizeof((info).semopm) == sizeof(char) ? (long long) (char) ((info).semopm) : sizeof((info).semopm) == sizeof(short) ? (long long) (short) ((info).semopm) : sizeof((info).semopm) == sizeof(int) ? (long long) (int) ((info).semopm) : sizeof((info).semopm) == sizeof(long) ? (long long) (long) ((info).semopm) : (long long) ((info).semopm))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semume"); tprintf_string("%lld", (sizeof((info).semume) == sizeof(char) ? (long long) (char) ((info).semume) : sizeof((info).semume) == sizeof(short) ? (long long) (short) ((info).semume) : sizeof((info).semume) == sizeof(int) ? (long long) (int) ((info).semume) : sizeof((info).semume) == sizeof(long) ? (long long) (long) ((info).semume) : (long long) ((info).semume))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semusz"); tprintf_string("%lld", (sizeof((info).semusz) == sizeof(char) ? (long long) (char) ((info).semusz) : sizeof((info).semusz) == sizeof(short) ? (long long) (short) ((info).semusz) : sizeof((info).semusz) == sizeof(int) ? (long long) (int) ((info).semusz) : sizeof((info).semusz) == sizeof(long) ? (long long) (long) ((info).semusz) : (long long) ((info).semusz))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semvmx"); tprintf_string("%lld", (sizeof((info).semvmx) == sizeof(char) ? (long long) (char) ((info).semvmx) : sizeof((info).semvmx) == sizeof(short) ? (long long) (short) ((info).semvmx) : sizeof((info).semvmx) == sizeof(int) ? (long long) (int) ((info).semvmx) : sizeof((info).semvmx) == sizeof(long) ? (long long) (long) ((info).semvmx) : (long long) ((info).semvmx))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("semaem"); tprintf_string("%lld", (sizeof((info).semaem) == sizeof(char) ? (long long) (char) ((info).semaem) : sizeof((info).semaem) == sizeof(short) ? (long long) (short) ((info).semaem) : sizeof((info).semaem) == sizeof(int) ? (long long) (int) ((info).semaem) : sizeof((info).semaem) == sizeof(long) ? (long long) (long) ((info).semaem) : (long long) ((info).semaem))); } while (0);
 tprint_struct_end();
}
int sys_semctl(struct tcb *tcp)
{
 ...
 if (cmd & 0x0100)
  cmd &= ~0x0100;
 if ((!((tcp)->flags & 0x04))) {
  tprintf_string("%lld", (sizeof((int) tcp->u_arg[0]) == sizeof(char) ? (long long) (char) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(short) ? (long long) (short) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(int) ? (long long) (int) ((int) tcp->u_arg[0]) : sizeof((int) tcp->u_arg[0]) == sizeof(long) ? (long long) (long) ((int) tcp->u_arg[0]) : (long long) ((int) tcp->u_arg[0])));
  tprint_arg_next();
  tprintf_string("%lld", (sizeof((int) tcp->u_arg[1]) == sizeof(char) ? (long long) (char) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(short) ? (long long) (short) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(int) ? (long long) (int) ((int) tcp->u_arg[1]) : sizeof((int) tcp->u_arg[1]) == sizeof(long) ? (long long) (long) ((int) tcp->u_arg[1]) : (long long) ((int) tcp->u_arg[1])));
  tprint_arg_next();
