...
{
 tprint_struct_begin();
 do { tprints_field_name("sival_int"); tprintf_string("%lld", (sizeof((v).sival_int) == sizeof(char) ? (long long) (char) ((v).sival_int) : sizeof((v).sival_int) == sizeof(short) ? (long long) (short) ((v).sival_int) : sizeof((v).sival_int) == sizeof(int) ? (long long) (int) ((v).sival_int) : sizeof((v).sival_int) == sizeof(long) ? (long long) (long) ((v).sival_int) : (long long) ((v).sival_int))); } while (0);
 tprint_struct_next();
...
MPERS_PRINTER_DECL(void, print_sigevent, struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 case SIGEV_THREAD_ID:
  tprint_struct_next();
  do { tprints_field_name("sigev_notify_thread_id"); tprintf_string("%lld", (sizeof((sev).sigev_un.tid) == sizeof(char) ? (long long) (char) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(short) ? (long long) (short) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(int) ? (long long) (int) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(long) ? (long long) (long) ((sev).sigev_un.tid) : (long long) ((sev).sigev_un.tid))); } while (0);
  break;
 case SIGEV_THREAD:
  tprint_struct_next();
