...
print_blkpg_req(struct tcb *tcp, const struct_blkpg_ioctl_arg *blkpg)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("flags"); tprintf_string("%lld", (sizeof((*blkpg).flags) == sizeof(char) ? (long long) (char) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(short) ? (long long) (short) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(int) ? (long long) (int) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(long) ? (long long) (long) ((*blkpg).flags) : (long long) ((*blkpg).flags))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("datalen"); tprintf_string("%lld", (sizeof((*blkpg).datalen) == sizeof(char) ? (long long) (char) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(short) ? (long long) (short) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(int) ? (long long) (int) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(long) ? (long long) (long) ((*blkpg).datalen) : (long long) ((*blkpg).datalen))); } while (0);
 tprint_struct_next();
 tprints_field_name("data");
 if (!umoven_or_printaddr((tcp), (((kernel_ulong_t) (unsigned long) (blkpg->data))), sizeof(*(&p)), (void *) (&p))) {
  tprint_struct_begin();
  do { tprints_field_name("start"); tprintf_string("%lld", (sizeof((p).start) == sizeof(char) ? (long long) (char) ((p).start) : sizeof((p).start) == sizeof(short) ? (long long) (short) ((p).start) : sizeof((p).start) == sizeof(int) ? (long long) (int) ((p).start) : sizeof((p).start) == sizeof(long) ? (long long) (long) ((p).start) : (long long) ((p).start))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("length"); tprintf_string("%lld", (sizeof((p).length) == sizeof(char) ? (long long) (char) ((p).length) : sizeof((p).length) == sizeof(short) ? (long long) (short) ((p).length) : sizeof((p).length) == sizeof(int) ? (long long) (int) ((p).length) : sizeof((p).length) == sizeof(long) ? (long long) (long) ((p).length) : (long long) ((p).length))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("pno"); tprintf_string("%lld", (sizeof((p).pno) == sizeof(char) ? (long long) (char) ((p).pno) : sizeof((p).pno) == sizeof(short) ? (long long) (short) ((p).pno) : sizeof((p).pno) == sizeof(int) ? (long long) (int) ((p).pno) : sizeof((p).pno) == sizeof(long) ? (long long) (long) ((p).pno) : (long long) ((p).pno))); } while (0);
  tprint_struct_next();
