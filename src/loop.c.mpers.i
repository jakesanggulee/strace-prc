...
decode_loop_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("lo_number"); tprintf_string("%lld", (sizeof((info).lo_number) == sizeof(char) ? (long long) (char) ((info).lo_number) : sizeof((info).lo_number) == sizeof(short) ? (long long) (short) ((info).lo_number) : sizeof((info).lo_number) == sizeof(int) ? (long long) (int) ((info).lo_number) : sizeof((info).lo_number) == sizeof(long) ? (long long) (long) ((info).lo_number) : (long long) ((info).lo_number))); } while (0);
...
MPERS_PRINTER_DECL(int, loop_ioctl, struct tcb *tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case 0x4C81:
  tprint_arg_next();
  tprintf_string("%lld", (sizeof((int) arg) == sizeof(char) ? (long long) (char) ((int) arg) : sizeof((int) arg) == sizeof(short) ? (long long) (short) ((int) arg) : sizeof((int) arg) == sizeof(int) ? (long long) (int) ((int) arg) : sizeof((int) arg) == sizeof(long) ? (long long) (long) ((int) arg) : (long long) ((int) arg)));
  break;
 case 0x4C08:
 case 0x4C09:
  tprint_arg_next();
