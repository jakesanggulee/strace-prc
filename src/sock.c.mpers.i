     ...
     const kernel_ulong_t arg, const struct_ifreq *const ifr)
{
 ...
 case 0x8913:
  ...
  break;
 case 0x8933:
  do { tprints_field_name("ifr_ifindex"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x891e:
 case 0x891d:
  do { tprints_field_name("ifr_metric"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8922:
 case 0x8921:
 ...
 case 0x8943:
 case 0x8942:
  do { tprints_field_name("ifr_qlen"); tprintf_string("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8971:
 case 0x8970:
...
{
 tprintf_string("%lld", (sizeof(len) == sizeof(char) ? (long long) (char) (len) : sizeof(len) == sizeof(short) ? (long long) (short) (len) : sizeof(len) == sizeof(int) ? (long long) (int) (len) : sizeof(len) == sizeof(long) ? (long long) (long) (len) : (long long) (len)));
