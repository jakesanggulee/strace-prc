...
{
 tprint_struct_begin();
 do { tprints_field_name("tv_sec"); tprintf_string("%lld", (sizeof((*t).tv_sec) == sizeof(char) ? (long long) (char) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(short) ? (long long) (short) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(int) ? (long long) (int) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(long) ? (long long) (long) ((*t).tv_sec) : (long long) ((*t).tv_sec))); } while (0);
 tprint_struct_next();
