...
MPERS_PRINTER_DECL(void, printmqattr, struct tcb *const tcp, const kernel_ulong_t addr, const _Bool decode_flags)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("mq_maxmsg"); tprintf_string("%lld", (sizeof((attr).mq_maxmsg) == sizeof(char) ? (long long) (char) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(short) ? (long long) (short) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(int) ? (long long) (int) ((attr).mq_maxmsg) : sizeof((attr).mq_maxmsg) == sizeof(long) ? (long long) (long) ((attr).mq_maxmsg) : (long long) ((attr).mq_maxmsg))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mq_msgsize"); tprintf_string("%lld", (sizeof((attr).mq_msgsize) == sizeof(char) ? (long long) (char) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(short) ? (long long) (short) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(int) ? (long long) (int) ((attr).mq_msgsize) : sizeof((attr).mq_msgsize) == sizeof(long) ? (long long) (long) ((attr).mq_msgsize) : (long long) ((attr).mq_msgsize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mq_curmsgs"); tprintf_string("%lld", (sizeof((attr).mq_curmsgs) == sizeof(char) ? (long long) (char) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(short) ? (long long) (short) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(int) ? (long long) (int) ((attr).mq_curmsgs) : sizeof((attr).mq_curmsgs) == sizeof(long) ? (long long) (long) ((attr).mq_curmsgs) : (long long) ((attr).mq_curmsgs))); } while (0);
 tprint_struct_end();
}
