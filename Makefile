...
am__aclocal_m4_deps = $(top_srcdir)/src/xlat/ieee802154_addr_types.m4 \
	$(top_srcdir)/src/xlat/loop_flags_options.m4 \
	$(top_srcdir)/src/xlat/nl_xfrm_types.m4 \
	$(top_srcdir)/src/xlat/ptp_pin_funcs.m4 \
	$(top_srcdir)/src/xlat/rtnl_neigh_fdb_ext_attrs.m4 \
	$(top_srcdir)/src/xlat/rtnl_tc_action_attrs.m4 \
	$(top_srcdir)/src/xlat/st_check_enums.m4 \
	$(top_srcdir)/src/xlat/waitid_types.m4 \
...
CONFIG_CLEAN_FILES = debian/changelog doc/strace.1 \
	doc/strace-log-merge.1 strace.spec
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = bundled src tests tests-m32 tests-mx32
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/strace.spec.in \
...
ACLOCAL = ${SHELL} /root/strace-prc/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/strace-prc/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/strace-prc/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/strace-prc/build-aux/missing automake-1.16
AWK = gawk
BUILD_EXEEXT = 
BUILD_OBJEXT = 
CC = gcc
...
COPYRIGHT_YEAR = 2023
CPP = gcc -E
CPPFLAGS =  -I./bundled/linux/arch/x86/include/uapi -I./bundled/linux/include/uapi
CPPFLAGS_FOR_BUILD = 
CPPFLAGS_FOR_M32 =  -I./bundled/linux/arch/x86/include/uapi -I./bundled/linux/include/uapi
CPPFLAGS_FOR_MX32 =  -I./bundled/linux/arch/x86/include/uapi -I./bundled/linux/include/uapi
CPP_FOR_BUILD = gcc -E
CPP_FOR_M32 = gcc -E
CPP_FOR_MX32 = gcc -E
CYGPATH_W = echo
DEB_CHANGELOGTIME = Fri, 13 Jan 2023 10:48:15 +0000
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/strace-prc/build-aux/missing makeinfo
MIPS_ABI = 
...
RANLIB = ranlib
READELF = readelf
RPM_CHANGELOGTIME = Fri Jan 13 2023
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/bash
SIZEOF_KERNEL_LONG_T = 8
SIZEOF_LONG = 8
SLM_MANPAGE_DATE = 2022-01-01
STRACE_MANPAGE_DATE = 2022-10-16
STRIP = 
VALGRIND = 
VALGRIND_ENABLED = no
VERSION = UNKNOWN
...
abs_top_srcdir = /root/strace-prc
ac_ct_AR = ar
ac_ct_CC = gcc
...
install_sh = ${SHELL} /root/strace-prc/build-aux/install-sh
karch = x86
karch_m32 = x86
karch_mx32 = x86
...
doc/strace.1: $(top_builddir)/config.status $(top_srcdir)/doc/strace.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
doc/strace-log-merge.1: $(top_builddir)/config.status $(top_srcdir)/doc/strace-log-merge.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
