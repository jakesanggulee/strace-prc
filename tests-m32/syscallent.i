...
[500 + 1] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(socket), "socket" },
[500 + 2] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(bind), "bind" },
[500 + 3] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(connect), "connect" },
[500 + 4] = { 2, TRACE_INDIRECT_SUBCALL|TN, SEN(listen), "listen" },
[500 + 5] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(accept), "accept" },
[500 + 6] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(getsockname), "getsockname" },
[500 + 7] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(getpeername), "getpeername" },
[500 + 8] = { 4, TRACE_INDIRECT_SUBCALL|TN, SEN(socketpair), "socketpair" },
[500 + 9] = { 4, TRACE_INDIRECT_SUBCALL|TN, SEN(send), "send" },
[500 + 10] = { 4, TRACE_INDIRECT_SUBCALL|TN, SEN(recv), "recv" },
[500 + 11] = { 6, TRACE_INDIRECT_SUBCALL|TN, SEN(sendto), "sendto" },
[500 + 12] = { 6, TRACE_INDIRECT_SUBCALL|TN, SEN(recvfrom), "recvfrom" },
[500 + 13] = { 2, TRACE_INDIRECT_SUBCALL|TN, SEN(shutdown), "shutdown" },
[500 + 14] = { 5, TRACE_INDIRECT_SUBCALL|TN, SEN(setsockopt), "setsockopt" },
[500 + 15] = { 5, TRACE_INDIRECT_SUBCALL|TN, SEN(getsockopt), "getsockopt" },
[500 + 16] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(sendmsg), "sendmsg" },
[500 + 17] = { 3, TRACE_INDIRECT_SUBCALL|TN, SEN(recvmsg), "recvmsg" },
[500 + 18] = { 4, TRACE_INDIRECT_SUBCALL|TN, SEN(accept4), "accept4" },
[500 + 19] = { 5, TRACE_INDIRECT_SUBCALL|TN, SEN(recvmmsg), "recvmmsg" },
[500 + 20] = { 4, TRACE_INDIRECT_SUBCALL|TN, SEN(sendmmsg), "sendmmsg" },
[((500) + (21)) + 1] = { 4, TRACE_INDIRECT_SUBCALL|TI, SEN(semop), "semop" },
[((500) + (21)) + 2] = { 3, TRACE_INDIRECT_SUBCALL|TI, SEN(semget), "semget" },
[((500) + (21)) + 3] = { 4, TRACE_INDIRECT_SUBCALL|TI, SEN(semctl), "semctl" },
[((500) + (21)) + 4] = { 5, TRACE_INDIRECT_SUBCALL|TI, SEN(semtimedop), "semtimedop" },
[((500) + (21)) + 11] = { 4, TRACE_INDIRECT_SUBCALL|TI, SEN(msgsnd), "msgsnd" },
[((500) + (21)) + 12] = { 5, TRACE_INDIRECT_SUBCALL|TI, SEN(msgrcv), "msgrcv" },
[((500) + (21)) + 13] = { 2, TRACE_INDIRECT_SUBCALL|TI, SEN(msgget), "msgget" },
[((500) + (21)) + 14] = { 4, TRACE_INDIRECT_SUBCALL|TI, SEN(msgctl), "msgctl" },
[((500) + (21)) + 21] = { 4, TRACE_INDIRECT_SUBCALL|TI|TM|SI, SEN(shmat), "shmat" },
[((500) + (21)) + 22] = { 4, TRACE_INDIRECT_SUBCALL|TI|TM|SI, SEN(shmdt), "shmdt" },
[((500) + (21)) + 23] = { 3, TRACE_INDIRECT_SUBCALL|TI, SEN(shmget), "shmget" },
[((500) + (21)) + 24] = { 4, TRACE_INDIRECT_SUBCALL|TI, SEN(shmctl), "shmctl" },
